...
<div class="panel panel-default">
    <div class="panel-heading"><h3><?php echo __('Edition') ?></h3></div>
    <div class="panel-body">
        <p><strong><?php echo __('Year'); ?>: </strong> <?php echo $edition['Edition']['year']; ?></p>
    </div>
</div>
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <?php echo $this->Form->create('Edition', array('id' => 'CoordinatorUserForm', 'url' => array('controller' => 'Editions', 'action' => 'addCoordinatorUser'), 'role' => 'form', 'class' => 'form-inline')); ?>
        ...
        <?php echo $this->Form->hidden('CoordinatorUser.coordinator_id', array('value' => $edition['Coordinator']['id'])); ?>
        ...
        <table class="table table-striped table-hover table-condensed">
            ...
            <tbody>
                <?php if (empty($coordinators)): ?>
                    <tr>
                        <td colspan="5"><?php echo __('There are no registered coordinators for this edition'); ?></td>
                    </tr>
                <?php else: ?>
                    <?php foreach ($coordinators as $record) : ?>
                        <tr>
                            ...
                            <td>
                                <?php echo $this->Form->postLink(__("<i class='fa fa-trash-o'></i>"), array('controller' => 'Editions', 'action' => 'deleteCoordinatorUser', $record['CoordinatorUser']['id']), array('class' => 'btn btn-sm btn-danger', 'title' => __('Remove coordinator this edition'), 'escape' => false, 'confirm' => __('Are you sure?'))); ?>
                            </td>
                            <td>
                                <?php echo $this->Form->postLink(__("<i class='fa fa-file-pdf-o'></i>"), array('controller' => 'Editions', 'action' => 'viewCertificateCoordinator', 'ext' => 'pdf', $record['Coordinator']['id'], $record['User']['id']), array('class' => 'btn btn-sm btn-default', 'title' => __('View certificate this coordinator'), 'escape' => false)); ?>
                            </td>
                            <td>
                                <?php echo $this->Form->postLink(__("<i class='fa fa-envelope-o'></i>"), array('controller' => 'Editions', 'action' => 'sendCertificateCoordinator', $record['Coordinator']['id'], $record['User']['id']), array('class' => 'btn btn-sm btn-success', 'title' => __('Send certificate for coordinator'), 'escape' => false)); ?>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php endif; ?>
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <?php echo $this->Form->create('Edition', array('id' => 'PresenterUserForm', 'url' => array('controller' => 'Editions', 'action' => 'addPresenterUser'), 'role' => 'form', 'class' => 'form-inline')); ?>
        <div class="input-group">
            <div class="input-group-addon"><i class="fa fa-user"></i></div>
        ...
        <?php echo $this->Form->hidden('PresenterUser.presenter_id', array('value' => $edition['Presenter']['id'])); ?>
        ...
        <table class="table table-striped table-hover table-condensed">
            ...
            <tbody>
                <?php if (empty($presenters)): ?>
                    <tr>
                        <td colspan="6"><?php echo __('There are no registered presenters for this edition'); ?></td>
                    </tr>
                <?php else: ?>
                    <?php foreach ($presenters as $record) : ?>
                        <tr>
                            ...
                            <td><?php echo $record['User']['document']; ?></td>
                            <td>
                                <?php echo $this->Form->postLink(__("<i class='fa fa-trash-o'></i>"), array('controller' => 'Editions', 'action' => 'deletePresenterUser', $record['PresenterUser']['id']), array('class' => 'btn btn-sm btn-danger', 'title' => __('Remove presenter this edition'), 'escape' => false, 'confirm' => __('Are you sure?'))); ?>
                            </td>
                            <td>
                                <?php echo $this->Form->postLink(__("<i class='fa fa-file-pdf-o'></i>"), array('controller' => 'Editions', 'action' => 'viewCertificatePresenter', 'ext' => 'pdf', $record['Presenter']['id'], $record['User']['id']), array('class' => 'btn btn-sm btn-default', 'title' => __('View certificate this presenter'), 'escape' => false)); ?>
                            </td>
                            <td>
                                <?php echo $this->Form->postLink(__("<i class='fa fa-envelope-o'></i>"), array('controller' => 'Editions', 'action' => 'sendCertificatePresenter', $record['Edition']['id'], $record['Presenter']['id'], $record['User']['id']), array('class' => 'btn btn-sm btn-success', 'title' => __('Send certificate for presenter'), 'escape' => false)); ?>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php endif; ?>
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <?php echo $this->Form->create('Edition', array('id' => 'ListenerUserForm', 'url' => array('controller' => 'Editions', 'action' => 'addListenerUser'), 'role' => 'form', 'class' => 'form-inline')); ?>
        <div class="input-group">
            <div class="input-group-addon"><i class="fa fa-user"></i></div>
        ...
        <?php echo $this->Form->hidden('ListenerUser.listener_id', array('value' => $edition['Listener']['id'])); ?>
        ...
        <table class="table table-striped table-hover table-condensed">
            ...
            <tbody>
                <?php if (empty($listeners)): ?>
                    <tr>
                        <td colspan="6"><?php echo __('There are no registered listeners for this edition'); ?></td>
                    </tr>
                <?php else: ?>
                    <?php foreach ($listeners as $record) : ?>
                        <tr>
                            ...
                            <td><?php echo $record['User']['document']; ?></td>
                            <td>
                                <?php echo ($record['ListenerUser']['attended'] == 1 ? '' : $this->Form->postLink(__("<i class='fa fa-check'></i>"), array('controller' => 'Editions', 'action' => 'attendListenerUser', $record['Listener']['id'], $record['User']['id']), array('class' => 'btn btn-sm btn-info', 'title' => __('Confirm attend for this listener'), 'escape' => false))); ?>
                            </td>
                            <td>
                                <?php echo $this->Form->postLink(__("<i class='fa fa-trash-o'></i>"), array('controller' => 'Editions', 'action' => 'deleteListenerUser', $record['ListenerUser']['id']), array('class' => 'btn btn-sm btn-danger', 'title' => __('Remove listener this edition'), 'escape' => false, 'confirm' => __('Are you sure?'))); ?>
                            </td>
                            <td>
                                <?php echo ($record['ListenerUser']['attended'] == 0 ? '' : $this->Form->postLink(__("<i class='fa fa-file-pdf-o'></i>"), array('controller' => 'Editions', 'action' => 'viewCertificateListener', 'ext' => 'pdf', $record['Listener']['id'], $record['User']['id']), array('class' => 'btn btn-sm btn-default', 'title' => __('View certificate this listener'), 'escape' => false))); ?>
                            </td>
                            <td>
                                <?php echo ($record['ListenerUser']['attended'] == 0 ? '' : $this->Form->postLink(__("<i class='fa fa-envelope-o'></i>"), array('controller' => 'Editions', 'action' => 'sendCertificateListener', $record['Listener']['id'], $record['User']['id']), array('class' => 'btn btn-sm btn-success', 'title' => __('Send certificate for listener'), 'escape' => false))); ?>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php endif; ?>
...
<script type="text/javascript">
    jQuery(document).ready(function() {
        ...
        $("#CoordinatorUserForm").submit(function(edition) {
        ...
        $("#ListenerUserForm").submit(function(edition) {
